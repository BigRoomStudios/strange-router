...
const renderWithRouter = (route, ui) => {
    ...
    // TODO do I really need this? This doesn't help with testing
    // changing the route live — I wonder if this issue is here
    // because they're both root routes? Not sure
    cleanup();
...
it('renders childRoutes many levels deep', () => {
    ...
    renderWithRouter(
        '/root/nested/double/triple/quadruple',
        <Routes routes={routes} />
    );
